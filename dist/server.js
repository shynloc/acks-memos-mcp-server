...
export function createMemosMcpServer() {
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        try {
            switch (name) {
                ...
                case "update_memo": {
                    const { id, content, visibility, rowStatus } = args;
                ...
                case "search_memos": {
                    ...
                    const filteredMemos = (response.memos || []).filter((memo) => memo.content.toLowerCase().includes(lowerQuery));
                    return {
                        content: [
                            {
                                type: "text",
